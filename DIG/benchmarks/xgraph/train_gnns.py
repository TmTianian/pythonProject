...
class TrainModel(object):
    def __init__(self,
        ...
        # self.writer = SummaryWriter(log_dir='C:/Users/hp-pc/Desktop/Pycharm/DIG/benchmarks/xgraph/logs', comment='GCN')
    ...
    def train(self, train_params=None, optimizer_params=None):
        ...
        for epoch in range(num_epochs):
            ...
            # self.writer.add_scalar("Test/Accuracy", eval_acc, epoch)
            if num_early_stop > 0:
